-- Invite list: optional search (code/note) and created_asc sort.

drop function if exists admin_invite_codes_list(int, int, text, text);
...
revoke all on function admin_invite_codes_list(int, int, text, text, text) from public;
grant execute on function admin_invite_codes_list(int, int, text, text, text) to service_role;
revoke execute on function admin_invite_codes_list(int, int, text, text, text) from anon, authenticated;
