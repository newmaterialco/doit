-- Admin dashboard: invite list sort by created or last redemption date.

drop function if exists admin_invite_codes_list(int, int, text);
...
revoke all on function admin_invite_codes_list(int, int, text, text) from public;
grant execute on function admin_invite_codes_list(int, int, text, text) to service_role;
revoke execute on function admin_invite_codes_list(int, int, text, text) from anon, authenticated;
